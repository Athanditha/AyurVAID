...
def train():
    """Trains the Support Vector Machine (SVM) model and saves it to a file."""
    ...
    # Initialize the SVM classifier. We need probability=True to output dosha percentage logic later.
    model = SVC(probability=True, random_state=42)
    
    # Train the model on the training data (Finds the optimal hyperplane that separates the classes)
